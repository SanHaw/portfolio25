...
export default function About() {
  ...
  return (
  <>
    <div className="content-wrap px-3 md:px-6 pt-24 pb-40 relative">
      ...
      <section className="mt-8 grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-6 lg:items-center">
        <div className="order-1 lg:order-1">
          ...
          <p className="mt-3 text-gray-700">UX/UI designer | Graphic Designer
          ...
          <br />
          <p className="mt-3 text-gray-700">
            With a background in Computer Science, I’m comfortable working with both 
            creative and technical teams. I’m especially interested in projects that 
            have a real purpose behind them and give me the chance to understand 
            people, solve problems, and make information easier to navigate.
          </p>
          <br />
          <p className="mt-3 text-gray-700">
            Outside of work, I’m usually making art, trying a new creative hobby, volunteering for something, or collecting yet another interest to obsess over.
          </p>
        ...
        <div className="flex justify-center order-2 lg:order-2 min-w-0">
          <div className="w-56 sm:w-64 md:w-72 lg:w-80 aspect-square rounded-full overflow-hidden">
      ...
      {/* <section className="py-16 min-h-[65vh] max-w-[80vw] mx-auto">
        <div className="content-wrap">
          ...
          <div className="max-w-4xl mx-auto space-y-6"> */}
            ...
            {/* CUE Digital International - Active
            <div className="grid items-start gap-x-3 gap-y-1 justify-center" style={{ gridTemplateColumns: '1rem minmax(200px, 350px) minmax(120px, 150px)' }}>
              ...
              <div>
                <p className="font-semibold text-lg">CUE Digital International</p>
                <p className="text-gray-600 ml-4">Digital Designer</p>
              </div>
              <div className="text-right whitespace-nowrap">
                <p className="text-gray-600 invisible">.</p>
                <p className="text-gray-600">2026 - present</p>
              </div>
            </div> */}
            ...
            {/* <div className="grid items-start gap-x-3 gap-y-1 justify-center" style={{ gridTemplateColumns: '1rem minmax(200px, 350px) minmax(120px, 150px)' }}>
              ...
              <div>
                ...
                <p className="text-gray-600 ml-4">Visual/Brand Designer</p>
              </div>
              <div className="text-right whitespace-nowrap">
                <p className="text-gray-600 invisible">.</p>
            ...
            {/* <div className="grid items-start gap-x-3 gap-y-1 justify-center" style={{ gridTemplateColumns: '1rem minmax(200px, 350px) minmax(120px, 150px)' }}>
              <div className="w-4 h-4 rounded-full bg-yellow-400 mt-1"></div>
              <div>
                <p className="font-semibold text-lg">UXPH</p>
                <p className="text-gray-600 ml-4">Marketing & Creatives Volunteer</p>
              </div>
              <div className="text-right whitespace-nowrap">
                <p className="text-gray-600 invisible">.</p>
                <p className="text-gray-600">2025 - present</p>
            ...
            {/* <div className="grid items-start gap-x-3 gap-y-1 justify-center" style={{ gridTemplateColumns: '1rem minmax(200px, 350px) minmax(120px, 150px)' }}>
              ...
              <div>
                <p className="font-semibold text-lg">Symph</p>
                <p className="text-gray-600 ml-4">UX/UI Design Intern</p>
                <p className="text-gray-600 ml-4">Marketing Associate Intern</p>
              </div>
              <div className="text-right whitespace-nowrap">
                <p className="text-gray-600 invisible">.</p>
